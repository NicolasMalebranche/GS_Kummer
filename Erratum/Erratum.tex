...
\end{thm}
\begin{rmk}
Because of the Poincaré duality and the universal coefficient theorem, we have:
\begin{align}
\tors H^6=\tors H_2&=\tors H^3 & \tors H^6=\tors H_2&=\tors H^3
\end{align}
...
for all $k$. We denote by $A$ the class which generates $H^0(A,\Z)$.
\begin{itemize}
\item[(i)]
