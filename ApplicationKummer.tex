...
\begin{itemize}
\item[(1)]
First (\ref{l22}), (\ref{l3}), Proposition \ref{invariants} and Corollary \ref{utile'} will provide the $H^4$-normality of $(K_2(A),\iota)$ in Section \ref{H4}. The notion of $H^k$-normality is recall in the beginning of the section.
\item[(2)]
