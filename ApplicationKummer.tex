...
\begin{itemize}
\item[(1)]
First (\ref{l2}), (\ref{l3}), Proposition \ref{invariants} and Corollary \ref{utile'} will provide the $H^4$-normality in Section \ref{H4}.
\item[(2)]
...
\item[iii)]
By (\ref{l2}) and Proposition \ref{invariants}, we have $l_{1,-}^{2}(K_{2}(A))=l_{1,-}^{4}(K_{2}(A))=0.$
\item[iv)]
...
\end{align*}
By (\ref{l2}), (\ref{l3}) and Proposition \ref{invariants}:
...
Hence by (\ref{l2}), (\ref{l3}) and Proposition 3.2.8 of \cite{Lol}, we find that $H^{3}(U,\Z)=0$.
...
From Theorem 7.31 of \cite{Voisin}, (\ref{l2}), (\ref{l3}) and Proposition \ref{invariants}, we get the betti numbers.
