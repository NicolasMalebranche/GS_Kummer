...
\end{lemme}
\begin{proof}
The know that the monodromy acts on $A[2]$ as the symplectic group $\Sp A[2]$. Hence the monodromy action extends naturally to an action on the divisors $D_1,...,D_{35}$. Also this monodromy action represented by $Sp A[3]$ acts trivially on $D_{36}$ and on $\pi_{2*}(s^{*}(e))$. 
