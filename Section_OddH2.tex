...
\end{proof}
Now we will calculate the invariant $l_{1,-}^{2}(A\times A)$ and $l_{1,+}^{1}(A\times A)$ defined in Section 1.2 of \cite{Menet} (I also recall the definition in the redaction of the application).
\begin{lemma}\label{2}
...
\end{proof}
\subsection{Proof of $\alpha_3=0$}\label{=}
