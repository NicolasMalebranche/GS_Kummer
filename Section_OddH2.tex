...
\end{align*}
As before every elements $x\otimes y\in H^{2}(A\times A,\Z)$ are sent to $y\otimes x$ by the action of $\sigma_2$. Such an element is fixed by the action of $\sigma_2$ if $x=y$. It follows:
...
We want to show that this inclusion is an equality. We will proceed as follow, we first prove that $\pi_{*}b^{*}(H^{3}(A\times A,\Z))$ is primitive. Then, in Lemma \ref{primitive3}, it is shown that $\pi_{*}j_*b_{|E}^{*}(H^{1}(\Delta,\Z))$ is primitive and finally we remark that this implies that the sum $\pi_*b^{*}(H^{3}(A\times A,\Z))\oplus \pi_*j_*b_{|E}^{*}(H^{1}(\Delta,\Z))$ is primitive.  
...
\end{proof}
Now it is remaining to prove that $\pi_{*}b^{*}(H^{3}(A\times A,\Z))\oplus \pi_{*}j_*b_{|E}^{*}(H^{1}(\Delta,\Z))$ is primitive in $H^{3}(A^{[2]},\Z)$.
