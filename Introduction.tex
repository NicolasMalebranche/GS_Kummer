...
In algebraic geometry compact hyperk\"ahler manifolds became important objects of study in recent years, after the fundamental results by Beauville \cite{Beauville} and Huybrechts \cite{Huybrechts2}.
...
Taking $X$ a hyperkähler manifold of $K3^{[2]}$-type, in all these works a description of $\frac{H^{4}(X,\Z)}{\Sym^2(H^{2}(X,\Z))}$ was essential.
